...
use Notifications\Controller\EmailTemplateController;
use Application\Service\LogManager;

class EmailTemplateControllerFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new EmailTemplateController($authenticationService, $entityManager, $logManager, $LMSUtilities, $logger);
    }
}
