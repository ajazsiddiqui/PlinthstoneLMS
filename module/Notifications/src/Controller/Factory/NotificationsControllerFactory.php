...
use Notifications\Controller\NotificationsController;
...
class NotificationsControllerFactory implements FactoryInterface
{
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new NotificationsController($authenticationService, $entityManager, $logManager, $LMSUtilities, $logger);
    }
}
