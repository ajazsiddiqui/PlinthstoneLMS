...
use Masters\Controller\VirtualNumberController;
use Application\Service\LogManager;

class VirtualNumberControllerFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new VirtualNumberController($authenticationService, $entityManager, $logManager, $LMSUtilities, $logger);
    }
}
