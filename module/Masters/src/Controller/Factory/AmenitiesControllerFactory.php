...
use Masters\Controller\AmenitiesController;
use Application\Service\LogManager;

class AmenitiesControllerFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new AmenitiesController($authenticationService, $entityManager, $logManager, $LMSUtilities, $logger);
    }
}
