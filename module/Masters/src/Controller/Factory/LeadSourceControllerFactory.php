...
use Masters\Controller\LeadSourceController;
use Application\Service\LogManager;

class LeadSourceControllerFactory implements FactoryInterface
{
    /**
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null)
    {
        ...
        return new LeadSourceController($authenticationService, $entityManager, $logManager, $LMSUtilities, $logger);
    }
}
