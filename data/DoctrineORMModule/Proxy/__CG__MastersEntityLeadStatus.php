...
namespace DoctrineORMModule\Proxy\__CG__\Masters\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class LeadStatus extends \Masters\Entity\LeadStatus implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'Masters\\Entity\\LeadStatus' . "\0" . 'id', '' . "\0" . 'Masters\\Entity\\LeadStatus' . "\0" . 'name', '' . "\0" . 'Masters\\Entity\\LeadStatus' . "\0" . 'isPrimary', '' . "\0" . 'Masters\\Entity\\LeadStatus' . "\0" . 'category', '' . "\0" . 'Masters\\Entity\\LeadStatus' . "\0" . 'parents', '' . "\0" . 'Masters\\Entity\\LeadStatus' . "\0" . 'status', '' . "\0" . 'Masters\\Entity\\LeadStatus' . "\0" . 'createdBy', '' . "\0" . 'Masters\\Entity\\LeadStatus' . "\0" . 'dateCreated'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (LeadStatus $proxy) {
